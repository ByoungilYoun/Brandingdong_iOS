...
class BrandFirstTableViewCell: UITableViewCell {
    //MARK: - Properties
    
    static let identifier = "BrandFirstTableViewCell"
  ...
  extension BrandFirstTableViewCell : UICollectionViewDataSource {
  ...
  extension BrandFirstTableViewCell : UICollectionViewDelegate {
  ...
  extension BrandFirstTableViewCell : UICollectionViewDelegateFlowLayout {
