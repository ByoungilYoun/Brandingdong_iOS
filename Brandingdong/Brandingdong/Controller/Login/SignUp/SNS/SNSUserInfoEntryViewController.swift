//
//  SNSUserInfoEntryViewController.swift
//  Brandingdong
//
...
class SNSUserInfoEntryViewController: UIViewController {
  // MARK: - Property
  
  private let sNSUserinfoEntryTableView = SNSUserinfoEntryTableView()
  ...
  private func setUI() {
    view.addSubview(sNSUserinfoEntryTableView)
  }
  
  private func setConstraints() {
    
    sNSUserinfoEntryTableView.snp.makeConstraints {
